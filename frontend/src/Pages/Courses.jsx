  ...
  return (
    <>
      ...
      <div className="dark:bg-slate-900">
        ...
        <h3 className='w-5/6 m-auto text-2xl text-center text-pink-600 pt-10'>A huge variety of courses on following and other topics are available. Please visit our book store or order online..
        </h3>
